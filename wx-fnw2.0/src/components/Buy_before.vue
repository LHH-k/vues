...
<script>
  ...
  export default {
    ...
    created(){
      ...
      }else if(this.$route.params.type == 4 || this.$route.params.type == 5){
      ...
      //product_id选择
      if(this.$route.params.type == 3){ //家电维修
        this.product_id = 2;
      }else if(this.$route.params.type == 4){ //99家电清洗
        this.product_id = 31;
      }else if(this.$route.params.type == 5){ //360家电清洗
        this.product_id = 30;
      }else{
        this.product_id = 1; 
      }
            ...
            if (res.data.res) {
              ...
              this.$http.post(`${BASE_URL}/fnw/post/NewUserAddress/${localStorage.getItem('phone')}`,adds).then((res)=>{
                if(res.data.res){
                  ...
                  //家庭维修直接生成新订单 (家电清洗)
                  if(this.$route.params.type == 3 || this.$route.params.type == 4 || this.$route.params.type == 5){
                    let datas = {
                      name:	data.name,
                      id_card: '',
