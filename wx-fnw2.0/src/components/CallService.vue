  ...
  <div class="BOXS callService" v-if="userInfo">
    <div class="box box1">
      ...
      <div class="box-c bg-white my-field">
        <van-cell-group>
          ...
          <van-field v-if="hash==3||hash==4" v-model="form.service.name" label="服务项目：" placeholder="请选择您需要服务的项目" @focus="addsShow = true" readonly ></van-field>
    ...
    <van-popup v-model="submitShow" class='my-popup' prevent-scroll>
      ...
      <div class="c">
        ...
        <p class="prompt" style="margin: 5px 0;" v-if="hash==3">注：每次呼叫服务只能修复一处损坏。</p>
      </div>
      <div class="b">
...
export default {
  ...
  created: function created() {
    ...
    //product_id选择
    if(this.$route.params.type == 4){ //家电清洗
      this.product_id = 31;
    }else{ 
      this.product_id = 1; 
    }
  ...
  methods: {
    ...
    submit() {
      ...
      //如果是360呼叫
      if(this.hash==3||this.hash==4||this.hash==5){
        let datas = {
